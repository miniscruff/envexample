...
func NewConfig(args []string) (*Config, error) {
	...
	flagSet.StringVar(&cfg.ConfigStruct, "struct", "", "`struct` to build example from")
	flagSet.StringVar(&cfg.PackageName, "package", "main", "`package` our config struct is located in")
